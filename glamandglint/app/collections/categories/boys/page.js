...
import { useBag } from '@/app/context/Bagcontext'; // ✅ Import the global context

const boysOutfits = [
  { id: 1, name: 'Nehru Jacket Set', price: '₹1,400', img: '/collections/categories/boys/image.png' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {boysOutfits.map((item) => (
          <div key={item.id} className="bg-white p-4 rounded-xl shadow-md text-center">
            <img src={item.img} alt={item.name} className="w-full h-48 object-cover rounded mb-3" />
