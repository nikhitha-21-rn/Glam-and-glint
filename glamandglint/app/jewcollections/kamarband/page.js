...
const kamarband = [
  {
    id: 1,
    name: 'Traditional Kamarband',
    image: '/images/kamarband1.jpg',
    price: '₹799',
  },
  {
    id: 2,
    name: 'Pearl Chain Kamarband',
    image: '/images/kamarband2.jpg',
    price: '₹899',
  },
];

export default function KamarbandPage() {
  const addToBag = (item) => {
  ...
  return (
    <main className="min-h-screen bg-pink-50 p-6">
      <h1 className="text-3xl font-bold text-pink-600 mb-6">Kamarband</h1>
